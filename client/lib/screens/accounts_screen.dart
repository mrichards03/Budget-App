...
class _AccountsScreenState extends State<AccountsScreen> {
  ...
  Future<void> _updateAccountType(String id, AccountType newType) async {
    final apiService = Provider.of<ApiService>(context, listen: false);
    ApiResult result = await apiService.accounts.updateType(id, newType);
    if (result.isSuccess) {
      setState(() {
        _accounts = _accounts.map((a) {
          if (a.id == id) {
            return Account(
              ...
              organizationDomain: a.organizationDomain,
              accountType: newType,
...
class _AccountItem extends StatelessWidget {
  ...
  final Future<void> Function(String id, AccountType newType) onChange;
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: DropdownButton<AccountType>(
                    ...
                    onChanged: (AccountType? newValue) async {
